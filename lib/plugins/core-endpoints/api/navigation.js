...
var routesModel, documentationModel, cachedAuthResponse, cachedNoAuthResponse;
var NL = '\n';
...
function skipCacheIfAuthenticated(req, res) {
  console.log('[Navigation] Authenticated');
...
function stripAuthRequiredRoutes(object) {
  if (Array.isArray(object)) {
    ...
    if (object.metaData && object.metaData.authRequired) {
      return;
    }
    var result = {};
