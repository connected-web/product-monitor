...
var pluginsModel = require('./monitor/models/plugins')
var preflightModel = require('./monitor/models/preflight')()
var NL = '\n'
...
function configureRoutes (instance) {
  ...
  server.use('/external', express.static(__dirname + '/../monitoring/external'))
  server.use('/fonts', express.static(__dirname + '/../monitoring/fonts'))
