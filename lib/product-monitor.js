...
module.exports = function(config) {
  ...
  server.use('/monitoring/component', express.static(config.componentsPath));
  server.use('/favicon.ico', express.static(config.imagesPath + "favicon.ico"));
  ...
  server.get('/api', mainController.renderApiPage);
  server.get('/credits', mainController.renderCreditsPage);
  server.get('/status', mainController.renderStatusPage);
