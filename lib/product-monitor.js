...
function startServer(server, instance, config) {
  ...
  server.get('/docs/custom-api-endpoint-guide', mainController.createRenderFunctionFor('documentation/custom-api-endpoint-guide.fragment.html'));
  server.get('/docs/package-info', mainController.createRenderFunctionFor('documentation/package-info.fragment.html'));
