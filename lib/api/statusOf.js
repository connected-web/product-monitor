...
var resultsCache = {};
var requestTimeoutLimit = 1500;

instance.route = '/api/statusOf';
instance.cacheDuration = '59 seconds';
instance.description = 'Remotely checks a service endpoint, testing for response code, expected content, and expected content type. Stores a history of the last 10 checks for each URL.';
